...
| [mainframer](https://github.com/matthewdeanmartin/mainframer) | active | Suite of tools in python for gnucobol, gcobol development <br> <sub>Tags: gnucobol, gcobol, cobol</sub> |
...
| [mastodon-finder](https://github.com/matthewdeanmartin/mastodon-finder) | active | Find people to follow on mastodon. <br> <sub>Tags: mastodon, mastodon-py, social-media</sub> |
| [matthewdeanmartin](https://matthewdeanmartin.github.io/matthewdeanmartin/) | active | Profile and Portfolio generation tool <br> <sub>Tags: matthewdeanmartin</sub> |
...
| [matthewdeanmartin_pypi](https://github.com/matthewdeanmartin/matthewdeanmartin_pypi) | active | The matthewdeanmartin package, sort of the profile page pypi can't make. <br> <sub>Tags: identity</sub> |
...
| [swimming_game](https://github.com/matthewdeanmartin/swimming_game) | active | A two player rythm game. <br> <sub>Tags: game, html5, multiplayer, music, rhythm-game, two-player</sub> |
...
| [vacay](https://github.com/matthewdeanmartin/vacay) | active | Unknown expected value vacation themed lotto scratcher <br> <sub>Tags: gaming, lotto, recreation, scratcher, vacation, game</sub> |
| [what_is_matt_doing](https://matthewdeanmartin.github.io/what_is_matt_doing/) | active | gh action to summarize what I've done for LLM consumption <br> <sub>Tags: github-actions, llm, productivity, summarization</sub> |
...
| [xkcd_random](https://github.com/matthewdeanmartin/xkcd_random) | active | Drop in replacement for python's random module using the xkcd-221 algorithm <br> <sub>Tags: python, random, xkcd, novelty</sub> |
