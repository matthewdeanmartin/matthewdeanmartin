...
- [untruncate_json](https://github.com/matthewdeanmartin/untruncate_json) Turn truncated json into valid json. Translation of someone else's javascript to python. Fast.

## Python Coding Novelties

- [hermentic-seal](https://github.com/matthewdeanmartin/hermetic) A sandbox. Not very secure...yet.
...
- [tokipona.parser](https://github.com/matthewdeanmartin/tokipona.parser) Parse a toy natural language.
- [Hicmah](https://github.com/matthewdeanmartin/hicmah) Attempt to make a fast web logger

## Bash, Make, Gitlab Pipelines
...
- [Falling Food](https://github.com/matthewdeanmartin/falling_food)
- [Swimming Game](https://github.com/matthewdeanmartin/swimming_game)
- [The Lockdown House](https://github.com/matthewdeanmartin/the_lockdown_house)
...
- [parse_quick_parameters.sh](https://github.com/matthewdeanmartin/parse_quick_parameters.sh) Fix bash's named parameter situation.

## Always be training

- [json_kata](https://github.com/matthewdeanmartin/json_kata) API exercises.
- [interview_challenges](https://github.com/matthewdeanmartin/interview_challenges) I don't keep this one public all the time.

## Github is my CMS

- [blog](https://github.com/matthewdeanmartin/blog) My pelican blog. Published to cloudflare.
- [blog_comments](https://github.com/matthewdeanmartin/blog_comments) You can use git as your blog comment engine.
